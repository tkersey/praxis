...
const request = {
  ...
  payload: {
    ...
    phase: "decide",
    context: { listing: null, documents: [], latest_search: null, latest_test: null, latest_replace: null, mutations: [], evidence: { baseline_test_observed: false, latest_test_passed: false, mutation_count: 0, last_test_mutation_count: 0, test_count: 0, latest_read: { path: "", observed_test_count: 0 } } },
    strategy_local: null,
  },
};
