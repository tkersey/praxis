...
v1.0.5 derives the model-visible compiled ceiling from `maximum_mutation_operations`, proves the emitted Decision Contract and workspace adapter share that ceiling, and enforces any narrower receiver policy before approval or a new write. Idempotent already-applied results remain permitted at the receiver ceiling. No authority, ABI, effect protocol, file-count bound, or fuel bound changes.
