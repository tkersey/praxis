...
v1.0.5 derives the model-visible compiled ceiling from `maximum_mutation_operations`, proves the emitted Decision Contract and workspace adapter share that ceiling, and enforces any narrower receiver policy before approval or a new write. Only an exact retained request-bound approval may produce an idempotent already-applied result at the receiver ceiling; a fresh content-equal proposal is denied. No authority, ABI, effect protocol, file-count bound, or fuel bound changes.
